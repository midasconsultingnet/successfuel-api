...
class Avoir(BaseModel):
    ...
    date_emission = Column(DateTime, nullable=False)  # Anciennement "date"
    date_utilisation = Column(DateTime)  # Date d'utilisation de l'avoir
    date_expiration = Column(DateTime)  # Date d'expiration de l'avoir
