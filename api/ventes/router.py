...
# Endpoints pour les ventes de produits
@router.get("/",
            response_model=PaginatedResponse[schemas.VenteResponse],
...
async def get_ventes(
    ...
    Returns:
        PaginatedResponse[schemas.VenteResponse]: Réponse paginée contenant les ventes de produits
...
@router.get("/carburant",
            response_model=PaginatedResponse[schemas.VenteCarburantResponse],
...
async def get_ventes_carburant(
    ...
    Returns:
        PaginatedResponse[schemas.VenteCarburantResponse]: Réponse paginée contenant les ventes de carburant
...
@router.get("/creances_employes",
            response_model=PaginatedResponse[schemas.CreanceEmployeResponse],
...
async def get_creances_employes(
    ...
    Returns:
        PaginatedResponse[schemas.CreanceEmployeResponse]: Réponse paginée contenant les créances des employés
...
# Définir les routes avec paramètres après les routes avec chemins fixes
@router.get("/{vente_id}",
            response_model=schemas.VenteResponse,
