...
async def update_etat_initial_cuve_service(
    ...
    if stock_carburant:
        ...
        if etat_initial_data.cout_moyen is not None:
            stock_carburant.cout_moyen_pondere = etat_initial_data.cout_moyen
        if etat_initial_data.prix_vente is not None:
            stock_carburant.prix_vente = etat_initial_data.prix_vente
