...
def get_all_cuves(db: Session, skip: int = 0, limit: int = 100):
    return db.query(Cuve).offset(skip).limit(limit).all()
...
def get_all_carburants(db: Session, skip: int = 0, limit: int = 100):
    return db.query(Carburant).offset(skip).limit(limit).all()
...
def get_all_pistolets(db: Session, skip: int = 0, limit: int = 100):
    return db.query(Pistolet).offset(skip).limit(limit).all()
...
def get_all_fournisseurs(db: Session, skip: int = 0, limit: int = 100):
...
def get_all_employes(db: Session, skip: int = 0, limit: int = 100):
...
def get_all_tresoreries(db: Session, skip: int = 0, limit: int = 100):
    return db.query(Tresorerie).offset(skip).limit(limit).all()
